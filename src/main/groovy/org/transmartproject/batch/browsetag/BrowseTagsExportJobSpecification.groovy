...
final class BrowseTagsExportJobSpecification
    ...
    void munge(ExternalJobParametersInternalInterface ejp)
        ...
        if (ejp[EXPORT_BROWSE_TAGS_FILE]) {
            ejp[EXPORT_BROWSE_TAGS_FILE] = convertRelativeWritePath ejp, EXPORT_BROWSE_TAGS_FILE
        }
        ...
        if (ejp[EXPORT_BROWSE_TAG_TYPES_FILE]) {
            ejp[EXPORT_BROWSE_TAG_TYPES_FILE] = convertRelativeWritePath ejp, EXPORT_BROWSE_TAG_TYPES_FILE
        }
    }
}
